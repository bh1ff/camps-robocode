    ...
    <div className="min-h-screen bg-[#f0f7f7]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg sm:text-xl text-white/70 max-w-lg mb-4 leading-relaxed">
                Project-packed holiday tech camps for ages 6-17. Robotics, game development, 3D printing, and more.
              </p>
      ...
      <section id="activities" className="py-20 sm:py-28 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-[#05575c]/70 text-lg leading-relaxed">
                Every day is a guided project sprint. Your child works with real tools, solves real problems, and takes home real skills.
              </p>
            </div>
          </FadeIn>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { img: '/camp/IMG_5527.jpg', title: 'Robotics', desc: 'Build and program robots from scratch. Sensors, motors, and logic come to life.', color: '#00dcde' },
              { img: '/camp/IMG_5414.jpg', title: 'Game Development', desc: 'Design and code interactive games. From concept to playable build in a day.', color: '#ff00bf' },
              { img: '/camp/rc-70.jpg', title: '3D Printing', desc: 'Design digital models and watch them materialise. Real engineering, real output.', color: '#ff9752' },
              { img: '/camp/rc-61.jpg', title: 'Physical Activity', desc: 'Table tennis, team games, and active breaks. A healthy balance every day.', color: '#00dcde' },
            ].map((a, i) => (
      ...
      <section id="locations" className="py-20 sm:py-28 bg-white scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <FadeIn key={loc.name} delay={i * 150}>
                <div className="robo-card overflow-hidden hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    <h3 className="font-heading text-[#003439] text-base mb-4">{loc.name}</h3>
          ...
          <FadeIn>
            <div className="mt-8 p-5 rounded-2xl bg-[#edfffe] border border-[#00dcde]/20 text-center">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-[#05575c]/70 text-lg">Available at the Solihull centre. The more days, the bigger the saving.</p>
            </div>
          </FadeIn>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-white/40 text-sm leading-relaxed">
                Teaching tomorrow&apos;s skills, today. Hands-on tech education for ages 6-17.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <Link href="/book/haf" className="block text-white/50 hover:text-white text-sm transition-colors">Book HAF Camp</Link>
            ...
            <div>
              ...
              <div className="space-y-2 text-white/50 text-sm">
                ...
                <p>Robocode, The Exchange, 26 Haslucks Green Road, Shirley, B90 2EL</p>
              </div>
            </div>
          </div>

          <div className="mt-10 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-white/30 text-xs">&copy; {new Date().getFullYear()} RobocodeUK. All Rights Reserved.</p>
